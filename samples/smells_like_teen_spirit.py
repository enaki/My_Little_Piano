...
class SmellsLikeTennSpirit(Song):
    ...
    def play(self):
        ...
        self.smells_lite_teen_spirit_sequence_1()
        self.smells_lite_teen_spirit_sequence_2()
        self.smells_lite_teen_spirit_sequence_3()
        self.smells_lite_teen_spirit_sequence_4()
        self.smells_lite_teen_spirit_sequence_5()
    ...
    def smells_lite_teen_spirit_sequence_3(self):
        ...
        self.sequence_notes_frequencies = array.array('i',
                                       [o3['c'], o3['c'], o2['gs'], o2['gs'], o3['c'], o3['as'], o3['gs'], o3['g']])
    ...
    def smells_lite_teen_spirit_sequence_6(self, last_delay=2):
        ...
        self.sequence_notes = ['gs', 'g', 'gs', 'g', 'gs', 'g', 'gs', 'g', 'g', 'f']
        self.sequence_delays = array.array('f',
